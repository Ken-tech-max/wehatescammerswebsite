          ...
          <div className="flex flex-col md:flex-row justify-center items-center space-x-5">
            <div className="w-full md:w-1/2 flex flex-col justify-center items-center">
              ...
              <div className="overview-desc-panel text-white p-5">
                Gorilla Galaxy: Genesis is a collection of 777 unique, randomly generated Gorillas roaming on the Solana blockchain. 
                <br />
                <br />
        ...
        <div className="w-full px-5 md:px-16 pb-10 relative">
          ...
          <div className="panel-faq">
            ...
            <div className={activeFaqIndex == 1 ? 'faq active-faq' : 'faq'}>
                ...
                <div className={activeFaqIndex == 1 ? 'active-faq-content' : 'faq-content'}>The total supply of Genesis gorillas is 777.</div>
            </div>
            ...
            <div className={activeFaqIndex == 3 ? 'faq active-faq' : 'faq'}>
                ...
                <div className={activeFaqIndex == 3 ? 'active-faq-content' : 'faq-content'}>.75 SOL</div>
            </div>
