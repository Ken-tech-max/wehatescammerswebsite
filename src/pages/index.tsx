        ...
        <div className="w-full md:h-screen flex justify-center items-end background-overview-section">
          <div>
            ...
            <p className="text-white text-center overview-desc px-5 md:px-24">
              Genesis is a collection of 4444 unique, randomly generated Gorillas roaming on the Solana blockchain. Every Genesis Gorilla is unique and programmatically generated from over 130+ possible attributes and traits like background, fur, clothes, mouth, head, earrings and eyes. Some gorillas will be rarer than others. Owning a gorilla isn't just a cool picture. It is your ticket into our ecosystem, bringing you value in the real and digital world.
            </p>
          </div>
        </div>
      </section>
