...
import useNftFlexibleStake from '../hooks/use-nft-flexible-stake';
import StakeFlexibleItem from '../components/stake-flexible-item';
...
const FlexibleStake = () => {
    ...
    const { isLoading, poolData, stakedNfts, claimAmount, stakeNfts, unstakeNft, claimRewards } = useNftFlexibleStake();
